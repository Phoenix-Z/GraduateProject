...
opacity = 0.5
rects1 = plt.bar(index, means_paillier, bar_width, alpha=opacity, color='y', label='Paillier')
rects2 = plt.bar(index + bar_width, means_01encode, bar_width, color='r', label='01Encode')
